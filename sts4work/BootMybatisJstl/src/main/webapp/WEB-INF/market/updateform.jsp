		...
		<form action="update" method="post" enctype="multipart/form-data">
			...
			<table class="table table-bordered">
				<tr>
					...
					<td>
						<input type="text" name="sang" class="form-control" required="required" value="${dto.sang }">
					</td>
				</tr>
				<tr>
					<th class="table-light">단가</th>
					<td>
						<input type="text" name="dan" class="form-control" required="required" value="${dto.dan }">
					</td>
				</tr>
				<tr>
