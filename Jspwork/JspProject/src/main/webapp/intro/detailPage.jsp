...
<body>
	...
	<div style="margin: 50px 100px;">
		<table class="table table-bordered" style="width: 600px">
			<caption align="top"><b><%=dto.getName() %>님의 자개소개</b></caption>
			<tr>
				<th>이름</th>
				<td><%=dto.getName() %></td>
			</tr>
			...
			<tr>
				<td colspan="2" align="center">
					...
					<button type="button" class="btn btn-info" onclick=funcdel(<%=dto.getNum() %>)>삭제</button>
					<button type="button" class="btn btn-info" onclick="location.href='introList.jsp'">목록</button>
				</td>
			</tr>
		</table>
	</div>
