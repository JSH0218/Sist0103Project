		...
		<form action="updateaction.jsp">
			...
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						<input type="text" name="sang_name" required="required" class="form-control" style="width: 150px;" value="<%=dto.getSang_name()%>">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="price" required="required" class="form-control" style="width: 150px;" value="<%=dto.getPrice()%>">
					</td>
				</tr>
				<tr>
					<th class="table-success" width="100">입고일</th>
					<td>
						<input type="date" name="ipgoday" class="form-control" style="width: 150px;" value="<%=dto.getIpgoday()%>">
					</td>
				</tr>
				<tr>
