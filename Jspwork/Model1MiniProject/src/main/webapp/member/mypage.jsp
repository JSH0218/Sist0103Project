				...
				for(MemberDto dto:list){
					...
					<tr>
						<td rowspan="6" align="center" valign="middle" style="width: 200px;">
							<img src="image/user.jpg" id="mainimg">
						</td>
						<td style="width: 300px;">회원명: <%=dto.getName() %></td>
						<td rowspan="6" style="width: 150px;" align="center" valign="middle">
							<button type="button" class="btn btn-outline-info" onclick="location.href='index.jsp?main=member/updatepassform.jsp?id=<%=dto.getId() %>'">수정</button>
							<br><br>
	  ...
	  <div class="modal-dialog modal-sm">
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-danger btndel" data-bs-dismiss="modal" onclick="del($('#delnum').val(),$('#delpass').val())">삭제</button>
	      </div>
