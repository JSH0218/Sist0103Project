	...
	<form action="update" method="post">
		...
		<table class="table table-bordered" style="width: 400px;">
			...
			<tr>
				...
				<td>
					<input type="text" name="addr" style="width: 150px;" required="required" class="form-control" value="${dto.addr }">
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center">
					<button type="submit" class="btn btn-outline-info">DB수정</button>
