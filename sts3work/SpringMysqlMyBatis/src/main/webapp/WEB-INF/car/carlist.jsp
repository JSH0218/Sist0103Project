...
<body>
	<div style="margin: 50px 100px; width: 800px;">
		<button type="button" class="btn btn-info" style="margin-left: 600px;" onclick="location.href='writeform'">자동차정보입력</button>
		<br><br>
		...
		<table class="table table-bordered">
			...
			<c:forEach var="dto" items="${list }" varStatus="i">
				<tr align="center">
					...
					<td>${dto.carname }</td>
					<td>
						<div style="width: 20px; height: 20px; background: ${dto.carcolor}"></div>
					</td>
					<td>
